...
export const registerSchema = Yup.object({
  name: Yup.string()
    ...
    .required("Name is reqiured").typeError("Must be String"),
  surname: Yup.string().required("Surname is required").typeError("Must be String"),
  ...
  password: Yup.string()
    ...
    .matches(/[!@#$%^&*(),.?":{}|<>]/, "Least one spesific character").typeError("Must be String"),
